...
function About() {
  const { isMobile, getTypographyVariant, getSpacing, getGridSpacing, getContainerPadding } = useResponsive()
  ...
  const candidates = [
    {
      ...
      initials: 'AD',
      imageNote: 'The image reference shows "Alex.jpg" which would be displayed here.',
      bio: [
    ...
    },
    {
      ...
      initials: 'TS',
      imageNote: 'The image reference shows "Photo of Tracey" which would be displayed here.',
      bio: [
    ...
    },
    {
      ...
      position: 'Borough Council Candidate',
      initials: 'HL',
      imageNote: 'The image reference shows "Photo of Hallie" which would be displayed here.',
      bio: [
        'Enter text here'
      ]
    },
    {
      ...
      position: 'Borough Council Candidate',
      initials: 'JM',
      imageNote: 'The image reference shows "Photo of Janet" which would be displayed here.',
      bio: [
